...
1. ##### Fill in your package information
	...
	(Example: `"com.unity.2d.animation"`)
	...
	- `"hideInEditor"`: A boolean value that overrides the package visibility set by the package type. If set to `true`, your package and its Assets are **always** visible by default; if set to `false`, your package and its Assets are **always** hidden by default.
